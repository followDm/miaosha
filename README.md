...
源项目地址git@github.com:Grootzz/seckill.git

那个redis，我在腾讯云服务器上由于是docker安装的，而且我进去容器一直没找到哪里看mode的

最后只能在我本地安装，然后修改了IP，启动成功了。我的能力还有待提升啊

而且那个所谓的不能远程连接，不能除了127.0.0.1之外的IP，也不存在啊，我RDM一样连接了
